...
public class Tag implements Comparable<Tag> {
  ...
  public static class TagBuilder implements BuilderInterface<Tag> {
    ...
    @Override
    public Tag build() {
      return new Tag(name, desc, empty, where, depreciated, attributes, source, lineNumber, noSplit, ancestor, spansLines);
    }
   ...
   * @param lineNumber
   */
  private Tag(String name, String desc, String empty, String where, String depreciated, Map<String, Attribute> attributes, String source, int lineNumber, List noSplit, String ancestor, String spansLines) {
    this.name = name;
    this.desc = desc;
    this.where = where;
